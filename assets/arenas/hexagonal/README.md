...
Refinamento v2: bordas com contraste suave, pedra e metais mais foscos, musgo menos saturado. Após reconstruir o asset, execute `python scripts/refine_hex_materials.py` para aplicar a segunda passada aos GLBs. Geometria, UVs e layout permanecem iguais.
