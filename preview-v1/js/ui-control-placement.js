...
(function(){
  ...
  style.textContent=`
    ...
    #camera-zoom-indicator{right:52px!important;left:auto!important;bottom:16px!important;white-space:nowrap}
    ...
    @media(max-width:640px){#camera-lock-btn{right:6px;bottom:6px;width:32px;height:32px}#camera-zoom-indicator{right:46px!important;bottom:13px!important}#battle-speed-control #qa-auto-rounds-btn{min-width:42px;padding:0 5px;margin-right:2px}}
  `;
